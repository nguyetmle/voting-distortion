...
class Election(object):
  ...
  def ask_election_official(self, candidates_in_last):
    ...
    #loser =  input("Please type your choice:")
    return random_loser
  ...
  def perform_round(self):
    ...
    if loser_count > 1: # there is a tie for last place with 2+ candidates
      ...
      mycandidate = list(candidates_in_last.keys())[0]
...
##    sys.exit(1)
  ...
  myvotes = [Vote([candidates[0], candidates[1], candidates[2]]), Vote([candidates[0], candidates[8], candidates[9]])]
  election2 = Election(myvotes)
  winner = election2.run_election()
  print(winner)
